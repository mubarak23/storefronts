...
function Slider() {
  ...
  // styles
  const arrowStyle = "rounded-full bg-gray-100 flex justify-center items-center shadow-sm hover:cursor-pointer"
  return (
      ...
      {/* Slider div*/ }
        {slides.map((slide, index) => {
          if(index === activeSlide){
            return (
            <div className={`wrapper flex w-[100%] h-[500px] justify-center items-center 
              shadow-2xl rounded-lg border-[#c0c0c0] border-10px overflow-hidden relative` + slide.background } >
            ...
            <div className='flex flex-col flex-1 place-items-start justify-center ml-11'>
                <h2 className='text-[40px]'>{ slide.content.h2}</h2>
